...
// node_modules/.pnpm/mermaid@10.1.0/node_modules/mermaid/dist/infoDiagram-388842fb.js
var L = function() {
...
var N = false;
var X = (h) => {
  et.debug("Setting message to: " + h), F = h;
};
var q = () => F;
var B = (h) => {
  N = h;
...
var Q = (h, f, x) => {
  try {
    et.debug(`Rendering info diagram
` + h);
    const m = po().securityLevel;
    let _;
    m === "sandbox" && (_ = yh("#i" + f));
    const t = (m === "sandbox" ? yh(_.nodes()[0].contentDocument.body) : yh("body")).select("#" + f);
    ...
    et.error("Error while rendering info diagram"), et.error(m.message);
  }
};
var W = {
  draw: Q
...
//# sourceMappingURL=infoDiagram-388842fb-EGFEMLBP.js.map
