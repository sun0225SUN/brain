...
// node_modules/.pnpm/mermaid@10.1.0/node_modules/mermaid/dist/gitGraphDiagram-603d2a33.js
var me = function() {
...
me.parser = me;
var qe = me;
var te = po().gitGraph.mainBranchName;
var Be = po().gitGraph.mainBranchOrder;
var R = {};
var O = null;
var Q = {};
...
var ye2 = {};
var Ue = function(r) {
  et.debug("options str", r), r = r && r.trim(), r = r || "{}";
  try {
    ye2 = JSON.parse(r);
  } catch (n) {
...
var We = function(r, n, o, h) {
  et.debug("Entering commit:", r, n, o, h), n = _h.sanitizeText(n, po()), r = _h.sanitizeText(r, po()), h = _h.sanitizeText(h, po());
  const a = {
    id: n || F + "-" + fe(),
    message: r,
    seq: F++,
  ...
  O = a, R[a.id] = a, T[M] = a.id, et.debug("in pushCommit " + a.id);
};
var Qe = function(r, n) {
  if (r = _h.sanitizeText(r, po()), T[r] === void 0)
    T[r] = O != null ? O.id : null, Q[r] = { name: r, order: n ? parseInt(n, 10) : null }, Ee(r), et.debug("in createBranch");
  else {
    let o = new Error(
...
var Xe = function(r, n, o, h) {
  r = _h.sanitizeText(r, po()), n = _h.sanitizeText(n, po());
...
var Ze = function(r, n, o) {
  if (et.debug("Entering cherryPick:", r, n, o), r = _h.sanitizeText(r, po()), n = _h.sanitizeText(n, po()), o = _h.sanitizeText(o, po()), !r || R[r] === void 0) {
    let c = new Error(
...
var et2 = function() {
  R = {}, O = null;
  let r = po().gitGraph.mainBranchName, n = po().gitGraph.mainBranchOrder;
  T = {}, T[r] = null, Q = {}, Q[r] = { name: r, order: n }, M = r, F = 0, bo();
};
var tt = function() {
...
var _e = (r, n, o) => {
  const h = ye().gitGraph, a = r.append("g").attr("class", "commit-bullets"), c = r.append("g").attr("class", "commit-labels");
  let f = 0;
...
var pt = (r, n) => {
  const o = ye().gitGraph, h = r.append("g");
  n.forEach((a, c) => {
...
var ft = function(r, n, o, h) {
  ot();
  const a = ye(), c = a.gitGraph;
  et.debug("in gitgraph renderer", r + `
`, "id:", n, o), W = h.db.getCommits();
  ...
  const w = yh(`[id="${n}"]`);
  _e(w, W, false), c.showBranches && pt(w, f), ut(w, W), _e(w, W, true), _s.insertTitle(
    w,
    "gitTitleText",
    c.titleTopMargin,
...
//# sourceMappingURL=gitGraphDiagram-603d2a33-6TNJ6RRL.js.map
