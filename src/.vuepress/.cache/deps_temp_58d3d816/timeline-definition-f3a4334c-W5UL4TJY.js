...
// node_modules/.pnpm/mermaid@10.1.0/node_modules/mermaid/dist/timeline-definition-f3a4334c.js
var Y = function() {
  var n = function(k, r, a, h) {
    for (a = a || {}, h = k.length; h--; a[k[h]] = r)
      ;
    return a;
  }, t = [1, 2], e = [1, 5], s = [6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], i = [1, 15], o = [1, 16], l = [1, 17], y = [1, 18], g = [1, 19], d = [1, 23], m = [1, 24], S2 = [1, 27], _ = [4, 6, 9, 11, 17, 18, 20, 22, 23, 26, 27, 28], b = {
    trace: function() {
    },
    yy: {},
    ...
    table: [{ 3: 1, 4: t, 7: 3, 12: 4, 28: e }, { 1: [3] }, n(s, [2, 3], { 5: 6 }), { 3: 7, 4: t, 7: 3, 12: 4, 28: e }, { 13: 8, 29: [1, 9] }, { 29: [2, 21] }, { 6: [1, 10], 7: 22, 8: 11, 9: [1, 12], 10: 13, 11: [1, 14], 12: 4, 17: i, 18: o, 20: l, 22: y, 23: g, 24: 20, 25: 21, 26: d, 27: m, 28: e }, { 1: [2, 2] }, { 14: 25, 15: [1, 26], 31: S2 }, n([15, 31], [2, 22]), n(s, [2, 8], { 1: [2, 1] }), n(s, [2, 4]), { 7: 22, 10: 28, 12: 4, 17: i, 18: o, 20: l, 22: y, 23: g, 24: 20, 25: 21, 26: d, 27: m, 28: e }, n(s, [2, 6]), n(s, [2, 7]), n(s, [2, 11]), { 19: [1, 29] }, { 21: [1, 30] }, n(s, [2, 14]), n(s, [2, 15]), n(s, [2, 16]), n(s, [2, 17]), n(s, [2, 18]), n(s, [2, 19]), n(s, [2, 20]), { 11: [1, 31] }, { 16: 32, 30: [1, 33] }, { 11: [2, 24] }, n(s, [2, 5]), n(s, [2, 12]), n(s, [2, 13]), n(_, [2, 9]), { 14: 34, 31: S2 }, { 31: [2, 23] }, { 11: [1, 35] }, n(_, [2, 10])],
    ...
    parse: function(r) {
      ...
      for (var L2 in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, L2) && (E.yy[L2] = this.yy[L2]);
      ...
      for (var w, z, N, Q, F = {}, U, $, nt, q; ; ) {
        if (z = h[h.length - 1], this.defaultActions[z] ? N = this.defaultActions[z] : ((w === null || typeof w > "u") && (w = et2()), N = M[z] && M[z][w]), typeof N > "u" || !N.length || !N[0]) {
          var X = "";
          q = [];
          for (U in M[z])
...
var ht = function() {
  D.length = 0, J.length = 0, W = "", B.length = 0, bo();
};
var dt = function(n) {
  W = n, D.push(n);
};
...
var xt = function() {
  function n(i, o, l, y, g, d, m, S2) {
    const _ = o.append("text").attr("x", l + g / 2).attr("y", y + d / 2 + 5).style("font-color", S2).style("text-anchor", "middle").text(i);
    s(_, m);
  }
  function t(i, o, l, y, g, d, m, S2, _) {
    const { taskFontSize: b, taskFontFamily: v2 } = S2, I = i.split(/<br\s*\/?>/gi);
    for (let k = 0; k < I.length; k++) {
      const r = k * b - b * (I.length - 1) / 2, a = o.append("text").attr("x", l + g / 2).attr("y", y).attr("fill", _).style("text-anchor", "middle").style("font-size", b).style("font-family", v2);
  ...
  function e(i, o, l, y, g, d, m, S2) {
    const _ = o.append("switch"), v2 = _.append("foreignObject").attr("x", l).attr("y", y).attr("width", g).attr("height", d).attr("position", "fixed").append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    v2.append("div").attr("class", "label").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), t(i, _, l, y, g, d, m, S2), s(v2, m);
  }
  function s(i, o) {
    for (const l in o)
      l in o && i.attr(l, o[l]);
...
function _t(n, t) {
  n.each(function() {
    var e = yh(this), s = e.text().split(/(\s+|<br>)/).reverse(), i, o = [], l = 1.1, y = e.attr("y"), g = parseFloat(e.attr("dy")), d = e.text(null).append("tspan").attr("x", 0).attr("y", y).attr("dy", g + "em");
...
`), et.debug("timeline", s.db);
  ...
  et.debug("sections", _);
  let b = 0, v2 = 0, I = 0, k = 0, r = 50 + o, a = 50;
  k = 50;
  let h = 0, u = true;
  _.forEach(function(P) {
    ...
    et.debug("sectionHeight before draw", E), b = Math.max(b, E + 20);
  });
  let f = 0, c = 0;
  ...
  for (const [P, p] of m.entries()) {
    const E = {
      ...
      padding: 20,
      maxHeight: v2
    }, L2 = R.getVirtualNodeHeight(d, E, i);
    et.debug("taskHeight before draw", L2), v2 = Math.max(v2, L2 + 20), f = Math.max(f, p.events.length);
    let H = 0;
  ...
  et.debug("maxSectionHeight before draw", b), et.debug("maxTaskHeight before draw", v2), _ && _.length > 0 ? _.forEach((P) => {
    ...
    const L2 = d.append("g"), H = R.drawNode(L2, E, h, i);
    et.debug("sectionNode output", H), L2.attr("transform", `translate(${r}, ${k})`), a += b + 50, p.length > 0 && at(
      d,
      p,
      h,
      r,
  ...
  et.debug("bounds", M), S2 && d.append("text").text(S2).attr("x", M.width / 2 - o).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), I = u ? b + v2 + 150 : v2 + 100, d.append("g").attr("class", "lineWrapper").append("line").attr("x1", o).attr("y1", I).attr("x2", M.width + 3 * o).attr("y2", I).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), Qt(
    void 0,
    d,
...
var at = function(n, t, e, s, i, o, l, y, g, d, m) {
  var S2;
  for (const _ of t) {
    const b = {
      descr: _.task,
    ...
    et.debug("taskNode", b);
    const v2 = n.append("g").attr("class", "taskWrapper"), k = R.drawNode(v2, b, e, l).height;
    if (et.debug("taskHeight after draw", k), v2.attr("transform", `translate(${s}, ${i})`), o = Math.max(o, k), _.events) {
...
//# sourceMappingURL=timeline-definition-f3a4334c-W5UL4TJY.js.map
