...
// node_modules/.pnpm/mermaid@10.1.0/node_modules/mermaid/dist/svgDraw-0a992cdb.js
var M = 0;
var O = function(i, e, t, r, n) {
  const a = function(o) {
    switch (o) {
  ...
  const l = e.points, d = S().x(function(o) {
    return o.x;
  }).y(function(o) {
    return o.y;
  }).curve(We), s = i.append("path").attr("d", d(l)).attr("id", "edge" + M).attr("class", "relation");
  let g = "";
  ...
  let B = _s.calcLabelPosition(e.points);
  f = B.x, c = B.y;
  let x, v, N, m;
  if (p % 2 !== 0 && p > 1) {
    let o = _s.calcCardinalityPosition(
      t.relation.type1 !== "none",
      e.points,
      e.points[0]
    ), u = _s.calcCardinalityPosition(
      t.relation.type2 !== "none",
      e.points,
      e.points[p - 1]
    );
    et.debug("cardinality_1_point " + JSON.stringify(o)), et.debug("cardinality_2_point " + JSON.stringify(u)), x = o.x, v = o.y, N = u.x, m = u.y;
  }
  if (t.title !== void 0) {
  ...
  et.info("Rendering relation " + JSON.stringify(t)), t.relationTitle1 !== void 0 && t.relationTitle1 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type1").attr("x", x).attr("y", v).attr("fill", "black").attr("font-size", "6").text(t.relationTitle1), t.relationTitle2 !== void 0 && t.relationTitle2 !== "none" && i.append("g").attr("class", "cardinality").append("text").attr("class", "type2").attr("x", N).attr("y", m).attr("fill", "black").attr("font-size", "6").text(t.relationTitle2), M++;
};
var P = function(i, e, t, r) {
  et.debug("Rendering class ", e, t);
  const n = e.id, a = {
    id: n,
    label: e.id,
    width: 0,
  ...
  s = true, e.members.forEach(function(y) {
    _(B, y, s, t), s = false;
  });
  ...
  s = true, e.methods.forEach(function(y) {
    _(N, y, s, t), s = false;
  });
...
`);
  s.forEach(function(p) {
    et.debug(`Adding line: ${p}`), d.append("tspan").text(p).attr("class", "title").attr("dy", t.textHeight);
  });
...
var L = function(i) {
  let e = "", t = "";
  try {
    let r = i[1] ? i[1].trim() : "", n = i[2] ? i[2].trim() : "", a = i[3] ? Il(i[3].trim()) : "", l = i[4] ? i[4].trim() : "", d = i[5] ? i[5].trim() : "";
    t = r + n + a + " " + l, e = E(d);
  } catch {
    t = i;
  }
...
var G = function(i) {
  let e = "", t = "";
  try {
    let r = i[1] ? i[1].trim() : "", n = i[2] ? i[2].trim() : "", a = i[3] ? Il(i[3].trim()) : "", l = i[4] ? i[4].trim() : "", d = i[5] ? " : " + Il(i[5]).trim() : "";
    t = r + n + "(" + a + ")" + d, e = E(l);
  } catch {
    t = i;
  }
...
var R = function(i) {
  ...
  if (n > 1 && a > n && a <= i.length) {
    ...
    i.substring(a + 1, 1), t = E(i.substring(a + 1, a + 2)), e = l + d + "(" + Il(g.trim()) + ")", a < i.length && (r = i.substring(a + 2).trim(), r !== "" && (r = " : " + Il(r), e += r));
  } else
    e = Il(i);
  return {
    displayText: e,
...
//# sourceMappingURL=chunk-5LGF6MMJ.js.map
