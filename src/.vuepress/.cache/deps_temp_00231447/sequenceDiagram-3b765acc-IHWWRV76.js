...
// node_modules/.pnpm/mermaid@10.1.0/node_modules/mermaid/dist/sequenceDiagram-3b765acc.js
var Bt = function() {
  var t = function(rt2, m, w, k) {
    for (w = w || {}, k = rt2.length; k--; w[rt2[k]] = m)
      ;
    return w;
  }, e = [1, 2], s = [1, 3], n = [1, 5], i = [1, 7], a2 = [2, 5], o = [1, 15], l = [1, 17], u = [1, 19], h = [1, 21], T = [1, 22], y = [1, 23], p = [1, 29], x = [1, 30], b = [1, 31], L = [1, 32], v = [1, 33], M = [1, 34], I = [1, 35], B = [1, 36], V = [1, 37], z = [1, 38], G = [1, 39], Y = [1, 40], D = [1, 42], X = [1, 43], q = [1, 45], F = [1, 46], H = [1, 47], J = [1, 48], Q = [1, 49], E = [1, 50], P = [1, 53], _ = [1, 4, 5, 19, 21, 23, 26, 28, 34, 35, 36, 38, 40, 41, 42, 43, 44, 46, 48, 50, 51, 52, 53, 54, 56, 57, 62, 63, 64, 65, 73, 83], U = [4, 5, 21, 54, 56], N = [4, 5, 19, 21, 23, 26, 28, 34, 35, 36, 38, 40, 41, 42, 43, 44, 46, 48, 50, 54, 56, 57, 62, 63, 64, 65, 73, 83], Kt = [4, 5, 19, 21, 23, 26, 28, 34, 35, 36, 38, 40, 41, 42, 43, 44, 46, 48, 50, 53, 54, 56, 57, 62, 63, 64, 65, 73, 83], Gt = [4, 5, 19, 21, 23, 26, 28, 34, 35, 36, 38, 40, 41, 42, 43, 44, 46, 48, 50, 52, 54, 56, 57, 62, 63, 64, 65, 73, 83], Xt = [4, 5, 19, 21, 23, 26, 28, 34, 35, 36, 38, 40, 41, 42, 43, 44, 46, 48, 50, 51, 54, 56, 57, 62, 63, 64, 65, 73, 83], at = [71, 72, 73], et2 = [1, 125], Jt = [1, 4, 5, 7, 19, 21, 23, 26, 28, 34, 35, 36, 38, 40, 41, 42, 43, 44, 46, 48, 50, 51, 52, 53, 54, 56, 57, 62, 63, 64, 65, 73, 83], Mt = {
    trace: function() {
    },
    yy: {},
    ...
    performAction: function(m, w, k, g, A, c, Tt) {
      ...
      switch (A) {
        ...
        case 18:
          ...
          break;
        case 20:
          this.$ = { type: "sequenceIndex", sequenceIndex: Number(c[d - 2]), sequenceIndexStep: Number(c[d - 1]), sequenceVisible: true, signalType: g.LINETYPE.AUTONUMBER };
          break;
        case 21:
          this.$ = { type: "sequenceIndex", sequenceIndex: Number(c[d - 1]), sequenceIndexStep: 1, sequenceVisible: true, signalType: g.LINETYPE.AUTONUMBER };
          break;
        case 22:
          this.$ = { type: "sequenceIndex", sequenceVisible: false, signalType: g.LINETYPE.AUTONUMBER };
          break;
        case 23:
          this.$ = { type: "sequenceIndex", sequenceVisible: true, signalType: g.LINETYPE.AUTONUMBER };
          break;
        case 24:
    ...
    parse: function(m) {
      var w = this, k = [0], g = [], A = [null], c = [], Tt = this.table, d = "", bt = 0, Qt = 0, Te = 2, Zt2 = 1, ye = c.slice.call(arguments, 1), O = Object.create(this.lexer), lt = { yy: {} };
      ...
      function me() {
        var it;
        return it = g.pop() || O.lex() || Zt2, typeof it != "number" && (it instanceof Array && (g = it, it = g.pop()), it = w.symbols_[it] || it), it;
      }
...
` + O.showPosition() + `
Expecting ` + _t.join(", ") + ", got '" + (this.terminals_[W] || W) + "'" : Ot = "Parse error on line " + (bt + 1) + ": Unexpected " + (W == Zt2 ? "end of input" : "'" + (this.terminals_[W] || W) + "'"), this.parseError(Ot, {
            text: O.match,
    ...
    var rt2 = {
      ...
      setInput: function(m, w) {
        return this.yy = w || this.yy || {}, this._input = m, this._more = this._backtrack = this.done = false, this.yylineno = this.yyleng = 0, this.yytext = this.matched = this.match = "", this.conditionStack = ["INITIAL"], this.yylloc = {
          first_line: 1,
          first_column: 0,
          last_line: 1,
          last_column: 0
...
` + w + "^";
      ...
      next: function() {
        ...
        for (var A = this._currentRules(), c = 0; c < A.length; c++)
          if (k = this._input.match(this.rules[A[c]]), k && (!w || k[0].length > w[0].length)) {
            if (w = k, g = c, this.options.backtrack_lexer) {
              if (m = this.test_match(k, A[c]), m !== false)
                return m;
              if (this._backtrack) {
                w = false;
                continue;
        ...
        return w ? (m = this.test_match(w, A[g]), m !== false ? m : false) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
...
var Yt;
var st;
var Re = function(t, e, s) {
  vs.parseDirective(this, t, e, s);
};
var De = function(t) {
  xt.push({
    name: t.text,
...
var Ft = function(t, e, s, n) {
  let i = st;
  const a2 = ot[t];
  if (a2) {
    if (st && a2.box && st !== a2.box)
      throw new Error(
        "A same participant should only be defined in one Box: " + a2.name + " can't be in '" + a2.box.name + "' and in '" + st.name + "' at the same time."
      );
    if (i = a2.box ? a2.box : st, a2.box = i, a2 && e === a2.name && s == null)
      return;
  }
...
var R = function(t, e, s = { text: void 0, wrap: void 0 }, n) {
  if (n === Et.ACTIVE_END && Ve(t.actor) < 1) {
    let a2 = new Error("Trying to inactivate an inactive participant (" + t.actor + ")");
    throw a2.hash = {
      text: "->>-",
      token: "->>-",
      line: "1",
...
var dt = () => Yt !== void 0 ? Yt : po().sequence.wrap;
var Ge = function() {
  ot = {}, xt = [], j = [], Nt = false, bo();
};
var Xe = function(t) {
  ...
  return et.debug("parseMessage:", s), s;
};
var Je = function(t) {
  ...
  if (window && window.CSS)
    ...
    const a2 = new Option().style;
    a2.color = s, a2.color !== s && (s = "transparent", n = t.trim());
  }
  return {
    color: s,
    text: n !== void 0 ? Ye(n.replace(/^:?(?:no)?wrap:/, ""), po()) : void 0,
...
var ie = function(t, e) {
  ...
  try {
    ...
    et.error("error while parsing actor link text", n);
  }
};
var je = function(t, e) {
  const s = mt(t);
  try {
    ...
    var i = l.slice(0, n - 1).trim(), a2 = l.slice(n + 1).trim();
    o[i] = a2, Ht(s, o);
  } catch (o) {
    et.error("error while parsing actor link text", o);
  }
};
function Ht(t, e) {
  if (t.links == null)
...
var se = function(t, e) {
  ...
  try {
    ...
    et.error("error while parsing actor properties text", n);
  }
};
function ae(t, e) {
...
var re = function(t, e) {
  ...
  try {
    const i = n.innerHTML, a2 = JSON.parse(i);
    a2.properties && ae(s, a2.properties), a2.links && Ht(s, a2.links);
  } catch (i) {
    et.error("error while parsing actor details text", i);
  }
};
var t0 = function(t, e) {
...
var s0 = function(t, e, s, n, i) {
  if (e.links === void 0 || e.links === null || Object.keys(e.links).length === 0)
    return { height: 0, width: 0 };
  const a2 = e.links, o = e.actorCnt, l = e.rectData;
  var u = "none";
  i && (u = "block !important");
  const h = t.append("g");
  ...
  if (p.attr("class", "actorPopupMenuPanel" + T), p.attr("x", l.x), p.attr("y", l.height), p.attr("fill", l.fill), p.attr("stroke", l.stroke), p.attr("width", y), p.attr("height", l.height), p.attr("rx", l.rx), p.attr("ry", l.ry), a2 != null) {
    var x = 20;
    for (let v in a2) {
      var b = h.append("a"), L = Gi(a2[v]);
...
var le = function(t, e, s, n) {
  const i = t.append("image");
  i.attr("x", e), i.attr("y", s);
  var a2 = Gi(n);
  i.attr("xlink:href", a2);
};
var he = function(t, e, s, n) {
...
var gt = function(t, e) {
  let s = 0, n = 0;
  const i = e.text.split(_h.lineBreakRegex), [a2, o] = Ei(e.fontSize);
  let l = [], u = 0, h = () => e.y;
  ...
  for (let [T, y] of i.entries()) {
    e.textMargin !== void 0 && e.textMargin === 0 && a2 !== void 0 && (u = T * a2);
...
var de = function(t, e) {
  function s(i, a2, o, l, u) {
    return i + "," + a2 + " " + (i + o) + "," + a2 + " " + (i + o) + "," + (a2 + l - u) + " " + (i + o - u * 1.2) + "," + (a2 + l) + " " + i + "," + (a2 + l);
  }
...
var l0 = function(t, e, s, n) {
  const i = e.x + e.width / 2, a2 = e.y + 5, o = t.append("g");
  var l = o;
  n || (tt++, l.append("line").attr("id", "actor" + tt).attr("x1", i).attr("y1", a2).attr("x2", i).attr("y2", 2e3).attr("class", "actor-line").attr("stroke-width", "0.5px").attr("stroke", "#999"), l = o.append("g"), e.actorCnt = tt, e.links != null && (l.attr("id", "root-" + tt), ce("#root-" + tt, tt)));
  const u = At();
  var h = "actor";
...
var h0 = function(t, e, s, n) {
  const i = e.x + e.width / 2, a2 = e.y + 80;
  n || (tt++, t.append("line").attr("id", "actor" + tt).attr("x1", i).attr("y1", a2).attr("x2", i).attr("y2", 2e3).attr("class", "actor-line").attr("stroke-width", "0.5px").attr("stroke", "#999"));
  const o = t.append("g");
...
var f0 = function(t, e, s, n, i) {
  const a2 = At(), o = e.anchored;
  a2.x = e.startx, a2.y = e.starty, a2.class = "activation" + i % 3, a2.width = e.stopx - e.startx, a2.height = s - e.starty, vt(o, a2);
};
var x0 = function(t, e, s, n) {
  const {
    boxMargin: i,
    boxTextMargin: a2,
    labelBoxHeight: o,
  ...
  let x = Wt();
  x.text = s, x.x = e.startx, x.y = e.starty, x.fontFamily = u, x.fontSize = h, x.fontWeight = T, x.anchor = "middle", x.valign = "middle", x.tspan = false, x.width = l || 50, x.height = o || 20, x.textMargin = a2, x.class = "labelText", de(y, x), x = Wt(), x.text = e.title, x.x = e.startx + l / 2 + (e.stopx - e.startx) / 2, x.y = e.starty + i + a2, x.anchor = "middle", x.valign = "middle", x.textMargin = a2, x.class = "loopText", x.fontFamily = u, x.fontSize = h, x.fontWeight = T, x.wrap = true;
  let b = gt(y, x);
  return e.sectionTitles !== void 0 && e.sectionTitles.forEach(function(L, v) {
    if (L.message) {
      x.text = L.message, x.x = e.startx + (e.stopx - e.startx) / 2, x.y = e.sections[v].y + i + a2, x.class = "loopText", x.anchor = "middle", x.valign = "middle", x.tspan = false, x.fontFamily = u, x.fontSize = h, x.fontWeight = T, x.wrap = e.wrap, b = gt(y, x);
      let M = Math.round(
        b.map((I) => (I._groups || I)[0][0].getBBox().height).reduce((I, B) => I + B)
      );
      e.sections[v].height += M - (i + a2);
    }
...
var Ut = function() {
  function t(i, a2, o, l, u, h, T) {
    const y = a2.append("text").attr("x", o + u / 2).attr("y", l + h / 2 + 5).style("text-anchor", "middle").text(i);
    n(y, T);
  }
  function e(i, a2, o, l, u, h, T, y) {
    const { actorFontSize: p, actorFontFamily: x, actorFontWeight: b } = y, [L, v] = Ei(p), M = i.split(_h.lineBreakRegex);
    for (let I = 0; I < M.length; I++) {
      const B = I * L - L * (M.length - 1) / 2, V = a2.append("text").attr("x", o + u / 2).attr("y", l).style("text-anchor", "middle").style("font-size", v).style("font-weight", b).style("font-family", x);
  ...
  function s(i, a2, o, l, u, h, T, y) {
    const p = a2.append("switch"), b = p.append("foreignObject").attr("x", o).attr("y", l).attr("width", u).attr("height", h).append("xhtml:div").style("display", "table").style("height", "100%").style("width", "100%");
    b.append("div").style("display", "table-cell").style("text-align", "center").style("vertical-align", "middle").text(i), e(i, p, o, l, u, h, T, y), n(b, T);
  }
  function n(i, a2) {
    for (const o in a2)
      a2.hasOwnProperty(o) && i.attr(o, a2[o]);
  }
  return function(i) {
...
var _0 = function() {
  function t(i, a2, o, l, u, h, T) {
    const y = a2.append("text").attr("x", o).attr("y", l).style("text-anchor", "start").text(i);
    n(y, T);
  }
  function e(i, a2, o, l, u, h, T, y) {
    const { actorFontSize: p, actorFontFamily: x, actorFontWeight: b } = y, L = i.split(_h.lineBreakRegex);
    for (let v = 0; v < L.length; v++) {
      const M = v * p - p * (L.length - 1) / 2, I = a2.append("text").attr("x", o).attr("y", l).style("text-anchor", "start").style("font-size", p).style("font-weight", b).style("font-family", x);
...
var f = {
  ...
  updateBounds: function(t, e, s, n) {
    ...
    function o(l) {
      return function(h) {
        a2++;
        const T = i.sequenceItems.length - a2 + 1;
  ...
  insert: function(t, e, s, n) {
    const i = Math.min(t, s), a2 = Math.max(t, s), o = Math.min(e, n), l = Math.max(e, n);
    this.updateVal(f.data, "startx", i, Math.min), this.updateVal(f.data, "starty", o, Math.min), this.updateVal(f.data, "stopx", a2, Math.max), this.updateVal(f.data, "stopy", l, Math.max), this.updateBounds(i, o, a2, l);
  },
  newActivation: function(t, e, s) {
    const n = s[t.from.actor], i = St(t.from.actor).length || 0, a2 = n.x + n.width / 2 + (i - 1) * r.activationWidth / 2;
    this.activations.push({
      startx: a2,
      starty: this.verticalPos + 2,
      stopx: a2 + r.activationWidth,
      stopy: void 0,
      actor: t.from.actor,
...
var k0 = function(t, e) {
  ...
  const n = t.append("g"), i = S.drawRect(n, s), a2 = S.getTextObj();
  a2.x = e.startx, a2.y = e.starty, a2.width = s.width, a2.dy = "1em", a2.text = e.message, a2.class = "noteText", a2.fontFamily = r.noteFontFamily, a2.fontSize = r.noteFontSize, a2.fontWeight = r.noteFontWeight, a2.anchor = r.noteAlign, a2.textMargin = r.noteMargin, a2.valign = "center";
  const o = gt(n, a2), l = Math.round(
...
function L0(t, e) {
  ...
  const { startx: s, stopx: n, message: i } = e, a2 = _h.splitBreaks(i).length, o = _s.calculateTextDimensions(i, ut(r)), l = o.height / a2;
...
var P0 = function(t, e, s, n) {
  const { startx: i, stopx: a2, starty: o, message: l, type: u, sequenceIndex: h, sequenceVisible: T } = e, y = _s.calculateTextDimensions(l, ut(r)), p = S.getTextObj();
  p.x = i, p.y = o + 10, p.width = a2 - i, p.class = "messageText", p.dy = "1em", p.text = l, p.fontFamily = r.messageFontFamily, p.fontSize = r.messageFontSize, p.fontWeight = r.messageFontWeight, p.anchor = r.messageAlign, p.valign = "center", p.textMargin = r.wrapPadding, p.tspan = false, gt(t, p);
  const x = y.width;
  let b;
  i === a2 ? r.rightAngles ? b = t.append("path").attr(
    "d",
    `M  ${i},${s} H ${i + Math.max(r.width / 2, x / 2)} V ${s + 25} H ${i}`
  ) : b = t.append("path").attr(
    "d",
    "M " + i + "," + s + " C " + (i + 60) + "," + (s - 10) + " " + (i + 60) + "," + (s + 30) + " " + i + "," + (s + 20)
  ) : (b = t.append("line"), b.attr("x1", i), b.attr("y1", s), b.attr("x2", a2), b.attr("y2", s)), u === n.db.LINETYPE.DOTTED || u === n.db.LINETYPE.DOTTED_CROSS || u === n.db.LINETYPE.DOTTED_POINT || u === n.db.LINETYPE.DOTTED_OPEN ? (b.style("stroke-dasharray", "3, 3"), b.attr("class", "messageLine1")) : b.attr("class", "messageLine0");
  let L = "";
...
var qt = function(t, e, s, n, i, a2, o) {
...
var fe = function(t, e, s, n) {
  ...
  for (const o of s) {
    ...
    h.height > i && (i = h.height), h.width + l.x > a2 && (a2 = h.width + l.x);
  }
  return { maxHeight: i, maxWidth: a2 };
};
var xe = function(t) {
  rt(r, t), t.fontFamily && (r.actorFontFamily = r.noteFontFamily = r.messageFontFamily = t.fontFamily), t.fontSize && (r.actorFontSize = r.noteFontSize = r.messageFontSize = t.fontSize), t.fontWeight && (r.actorFontWeight = r.noteFontWeight = r.messageFontWeight = t.fontWeight);
};
var St = function(t) {
...
var $t = function(t, e) {
  ...
  }, s.x + s.width / 2), a2 = n.reduce(function(o, l) {
...
function $(t, e, s, n, i) {
  ...
  if (e.id && e.message && t[e.id]) {
    ...
    e.message = _s.wrapLabel(`[${e.message}]`, o - 2 * r.wrapPadding, l), e.width = o, e.wrap = true;
    const u = _s.calculateTextDimensions(e.message, l), h = Math.max(u.height, r.labelBoxHeight);
    a2 = n + h, et.debug(`${h} - ${e.message}`);
  }
  i(e), f.bumpVerticalPos(a2);
}
var I0 = function(t, e, s, n) {
  const { securityLevel: i, sequence: a2 } = po();
  r = a2, n.db.clear(), n.parser.parse(t);
  let o;
  i === "sandbox" && (o = yh("#i" + e));
  const l = i === "sandbox" ? yh(o.nodes()[0].contentDocument.body) : yh("body"), u = i === "sandbox" ? o.nodes()[0].contentDocument : document;
  f.init(), et.debug(n.db);
  const h = i === "sandbox" ? l.select(`[id="${e}"]`) : yh(`[id="${e}"]`), T = n.db.getActors(), y = n.db.getBoxes(), p = n.db.getActorKeys(), x = n.db.getMessages(), b = n.db.getDiagramTitle(), L = n.db.hasAtLeastOneBox(), v = n.db.hasAtLeastOneBoxWithTitle(), M = N0(T, x, n);
  r.height = A0(T, M, y), S.insertComputerIcon(h), S.insertDatabaseIcon(h), S.insertClockIcon(h), L && (f.bumpVerticalPos(r.boxMargin), v && f.bumpVerticalPos(y[0].textMaxHeight)), qt(h, T, p, 0, r, x, false);
  const I = R0(x, T, M, n);
    ...
    switch (E.type) {
      ...
      default:
        try {
          ...
          et.error("error while drawing message", N);
        }
    }
    [
  ...
  }), G.forEach((E) => P0(h, E.messageModel, E.lineStartY, n)), r.mirrorActors && (f.bumpVerticalPos(r.boxMargin * 2), qt(h, T, p, f.getVerticalPos(), r, x, true), f.bumpVerticalPos(r.boxMargin), ue(h, f.getVerticalPos())), f.models.boxes.forEach(function(E) {
  ...
  et.debug("For line height fix Querying: #" + e + " .actor-line"), a("#" + e + " .actor-line").attr("y2", D.stopy);
  ...
  b && h.append("text").text(b).attr("x", (D.stopx - D.startx) / 2 - 2 * r.diagramMarginX).attr("y", -25), Zt(h, F, J, r.useMaxWidth);
  const Q = b ? 40 : 0;
  h.attr(
    "viewBox",
    D.startx - r.diagramMarginX + " -" + (r.diagramMarginY + Q) + " " + J + " " + (F + Q)
  ), et.debug("models:", f.models);
};
function N0(t, e, s) {
  const n = {};
  return e.forEach(function(i) {
    if (t[i.to] && t[i.from]) {
      const a2 = t[i.to];
      if (i.placement === s.db.PLACEMENT.LEFTOF && !a2.prevActor || i.placement === s.db.PLACEMENT.RIGHTOF && !a2.nextActor)
        return;
      const o = i.placement !== void 0, l = !o, u = o ? ft(r) : ut(r), h = i.wrap ? _s.wrapLabel(i.message, r.width - 2 * r.wrapPadding, u) : i.message, y = _s.calculateTextDimensions(h, u).width + 2 * r.wrapPadding;
      l && i.from === a2.nextActor ? n[i.to] = Math.max(
        n[i.to] || 0,
        y
      ) : l && i.from === a2.prevActor ? n[i.from] = Math.max(
        n[i.from] || 0,
        y
        ...
        n[i.from] || 0,
        y
      ) : i.placement === s.db.PLACEMENT.LEFTOF ? n[a2.prevActor] = Math.max(
        n[a2.prevActor] || 0,
        y
      ) : i.placement === s.db.PLACEMENT.OVER && (a2.prevActor && (n[a2.prevActor] = Math.max(
        n[a2.prevActor] || 0,
        y / 2
      )), a2.nextActor && (n[i.from] = Math.max(
        n[i.from] || 0,
        y / 2
      )));
    }
  }), et.debug("maxMessageWidthPerActor:", n), n;
}
var v0 = function(t) {
  let e = 0;
  const s = zt(r);
  for (const n in t.links) {
    const a2 = _s.calculateTextDimensions(n, s).width + 2 * r.wrapPadding + 2 * r.boxMargin;
    e < a2 && (e = a2);
  }
  return e;
};
function A0(t, e, s) {
  ...
  Object.keys(t).forEach((a2) => {
    const o = t[a2];
    o.wrap && (o.description = _s.wrapLabel(
      o.description,
      r.width - 2 * r.wrapPadding,
      zt(r)
    ));
    const l = _s.calculateTextDimensions(o.description, zt(r));
  ...
  for (const a2 in e) {
    ...
    if (!l) {
      const y = e[a2] + r.actorMargin - o.width / 2;
      o.margin = Math.max(y, r.actorMargin);
      continue;
    }
    const h = e[a2] + r.actorMargin - o.width / 2 - l.width / 2;
    o.margin = Math.max(h, r.actorMargin);
  }
  let i = 0;
  return s.forEach((a2) => {
    const o = ut(r);
    let l = a2.actorKeys.reduce((T, y) => T += t[y].width + (t[y].margin || 0), 0);
    l -= 2 * r.boxTextMargin, a2.wrap && (a2.name = _s.wrapLabel(a2.name, l - 2 * r.wrapPadding, o));
    const u = _s.calculateTextDimensions(a2.name, o);
    i = Math.max(u.height, i);
    const h = Math.max(l, u.width + 2 * r.wrapPadding);
    if (a2.margin = r.boxTextMargin, l < h) {
      const T = (h - l) / 2;
      a2.margin += T;
    }
  }), s.forEach((a2) => a2.textMaxHeight = i), Math.max(n, r.height);
}
var S0 = function(t, e, s) {
  const n = e[t.from].x, i = e[t.to].x, a2 = t.wrap && t.message;
  let o = _s.calculateTextDimensions(
    a2 ? _s.wrapLabel(t.message, r.width, ft(r)) : t.message,
    ft(r)
  );
  const l = {
    width: a2 ? r.width : Math.max(r.width, o.width + 2 * r.noteMargin),
    height: 0,
    startx: e[t.from].x,
    stopx: 0,
    starty: 0,
  ...
  return t.placement === s.db.PLACEMENT.RIGHTOF ? (l.width = a2 ? Math.max(r.width, o.width) : Math.max(
    e[t.from].width / 2 + e[t.to].width / 2,
    o.width + 2 * r.noteMargin
  ), l.startx = n + (e[t.from].width + r.actorMargin) / 2) : t.placement === s.db.PLACEMENT.LEFTOF ? (l.width = Math.max(a2 ? r.width : e[t.from].width / 2 + e[t.to].width / 2, o.width + 2 * r.noteMargin), l.startx = n - l.width + (e[t.from].width - r.actorMargin) / 2) : t.to === t.from ? (o = _s.calculateTextDimensions(
    a2 ? _s.wrapLabel(t.message, Math.max(r.width, e[t.from].width), ft(r)) : t.message,
    ft(r)
  ), l.width = a2 ? Math.max(r.width, e[t.from].width) : Math.max(e[t.from].width, r.width, o.width + 2 * r.noteMargin), l.startx = n + (e[t.from].width - l.width) / 2) : (l.width = Math.abs(n + e[t.from].width / 2 - (i + e[t.to].width / 2)) + r.actorMargin, l.startx = n < i ? n + e[t.from].width / 2 - r.actorMargin / 2 : i + e[t.to].width / 2 - r.actorMargin / 2), a2 && (l.message = _s.wrapLabel(
    t.message,
...
var M0 = function(t, e, s) {
  ...
  if ([
    ...
    return {};
  const i = $t(t.from, e), a2 = $t(t.to, e), o = i[0] <= a2[0] ? 1 : 0, l = i[0] < a2[0] ? 0 : 1, u = [...i, ...a2], h = Math.abs(a2[l] - i[o]);
  t.wrap && t.message && (t.message = _s.wrapLabel(
    t.message,
    Math.max(h + 2 * r.wrapPadding, r.width),
    ut(r)
  ));
  const T = _s.calculateTextDimensions(t.message, ut(r));
  return {
    width: Math.max(
...
var R0 = function(t, e, s, n) {
  const i = {}, a2 = [];
  let o, l, u;
  return t.forEach(function(h) {
    switch (h.id = _s.random({ length: 10 }), h.type) {
      case n.db.LINETYPE.LOOP_START:
      case n.db.LINETYPE.ALT_START:
      case n.db.LINETYPE.OPT_START:
      case n.db.LINETYPE.PAR_START:
      ...
      case n.db.LINETYPE.PAR_AND:
      case n.db.LINETYPE.CRITICAL_OPTION:
        h.message && (o = a2.pop(), i[o.id] = o, i[h.id] = o, a2.push(o));
        break;
      case n.db.LINETYPE.LOOP_END:
      case n.db.LINETYPE.ALT_END:
      case n.db.LINETYPE.OPT_END:
    ...
    h.placement !== void 0 ? (l = S0(h, e, n), h.noteModel = l, a2.forEach((y) => {
    ...
    })) : (u = M0(h, e, n), h.msgModel = u, u.startx && u.stopx && a2.length > 0 && a2.forEach((y) => {
  ...
  }), f.activations = [], et.debug("Loop type widths:", i), i;
};
var D0 = {
  bounds: f,
  drawActors: qt,
...
//# sourceMappingURL=sequenceDiagram-3b765acc-IHWWRV76.js.map
