...
// node_modules/.pnpm/mermaid@10.1.0/node_modules/mermaid/dist/journeyDiagram-420adb66.js
var K = function() {
...
var $t = function() {
  Q.length = 0, N.length = 0, L = "", B.length = 0, bo();
};
var Et = function(e) {
  L = e, Q.push(e);
};
...
`);
  ...
  let l;
  o === "sandbox" && (l = yh("#i" + t));
  const y = o === "sandbox" ? yh(l.nodes()[0].contentDocument.body) : yh("body");
  S.init();
  const u = y.select("#" + t);
  j.initGraphics(u);
  ...
  Zt(u, v, _, s.useMaxWidth), u.append("line").attr("x1", C).attr("y1", s.height * 4).attr("x2", _ - C - 4).attr("y2", s.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const n = g ? 70 : 0;
...
//# sourceMappingURL=journeyDiagram-420adb66-GOHXMXZI.js.map
