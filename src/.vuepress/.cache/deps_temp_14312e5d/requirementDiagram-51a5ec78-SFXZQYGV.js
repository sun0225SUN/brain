...
// node_modules/.pnpm/mermaid@10.1.0/node_modules/mermaid/dist/requirementDiagram-51a5ec78.js
var he = function() {
...
var Ze = function(e, t, a) {
  vs.parseDirective(this, e, t, a);
};
var et2 = (e, t) => (G[e] === void 0 && (G[e] = {
  name: e,
  type: t,
  id: b.id,
  text: b.text,
...
var at = (e) => (z[e] === void 0 && (z[e] = {
  ...
  type: L.type,
  docRef: L.docRef
}, et.info("Added new requirement: ", e)), L = {}, z[e]);
var lt = () => z;
var ct = (e) => {
  L !== void 0 && (L.type = e);
};
...
var Et = function(e, t, a, c, d) {
  ...
  t.type == d.db.Relationships.CONTAINS ? h.attr(
    "marker-start",
    "url(" + _h.getUrl(y.arrowMarkerAbsolute) + "#" + t.type + "_line_ending)"
  ) : (h.attr("stroke-dasharray", "10,7"), h.attr(
    "marker-end",
    "url(" + _h.getUrl(y.arrowMarkerAbsolute) + "#" + Ae.ReqMarkers.ARROW + "_line_ending)"
  )), gt(e, h, y, `<<${t.type}>>`);
};
var Rt = (e, t, a) => {
  Object.keys(e).forEach((c) => {
    let d = e[c];
    c = W(c), et.info("Added new requirement: ", c);
...
var kt = (e, t, a, c) => {
  y = po().requirement, c.db.clear(), c.parser.parse(e);
  const d = y.securityLevel;
  let u;
  d === "sandbox" && (u = yh("#i" + t));
  const h = (d === "sandbox" ? yh(u.nodes()[0].contentDocument.body) : yh("body")).select(`[id='${t}']`);
  ...
  Zt(h, A2, v, y.useMaxWidth), h.attr("viewBox", `${T.x - S2} ${T.y - S2} ${v} ${A2}`);
};
var St = {
  draw: kt
};
...
//# sourceMappingURL=requirementDiagram-51a5ec78-SFXZQYGV.js.map
