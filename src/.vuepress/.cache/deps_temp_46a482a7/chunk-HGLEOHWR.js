...
// node_modules/.pnpm/mermaid@10.1.0/node_modules/mermaid/dist/edges-de377bae.js
var st = (r, t, e, n) => {
  t.forEach((a) => {
    bt[a](r, e, n);
  });
...
function ut(r) {
  const t = yh(document.createElementNS("http://www.w3.org/2000/svg", "foreignObject")), e = t.append("xhtml:div"), n = r.label, a = r.isNode ? "nodeLabel" : "edgeLabel";
  return e.html(
...
var yt = (r, t, e, n) => {
  let a = r || "";
  if (typeof a == "object" && (a = a[0]), Ol(po().flowchart.htmlLabels)) {
    a = a.replace(/\\n|\n/g, "<br />"), et.info("vertexText" + a);
    const s = {
      isNode: n,
      label: is(a).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
var S2 = (r, t, e, n) => {
  let a;
  const s = t.useHtmlLabels || Ol(po().flowchart.htmlLabels);
  ...
  const o = l.node();
  let h;
  t.labelType === "markdown" ? h = Nt(l, Ye(is(c), po()), {
    useHtmlLabels: s,
    width: t.width || po().flowchart.wrappingWidth,
...
var St = (r, t) => {
  t.useHtmlLabels || po().flowchart.htmlLabels || (t.centerLabel = true);
  const { shapeSvg: n, bbox: a, halfPadding: s } = S2(r, t, "node " + t.classes, true);
  et.info("Classes = ", t.classes);
...
var Et = St;
var q = (r, t) => {
  const { shapeSvg: e, bbox: n } = S2(r, t, void 0, true), a = n.width + t.padding, s = n.height + t.padding, i = a + s, l = [
    { x: i / 2, y: 0 },
    { x: i, y: -i / 2 },
    { x: i / 2, y: -i },
    { x: 0, y: -i / 2 }
  ];
  et.info("Question main (Circle)");
  const c = _(e, i, i, l);
  return c.attr("style", t.style), m(t, c), t.intersect = function(o) {
    return et.warn("Intersect called"), g.polygon(t, l, o);
  }, e;
};
var Bt = (r, t) => {
...
var Mt = (r, t) => {
  const { shapeSvg: e, bbox: n } = S2(r, t, void 0, true), a = 4, s = n.height + t.padding, i = s / a, l = n.width + 2 * i + t.padding, c = [
    { x: i, y: 0 },
    { x: l - i, y: 0 },
    { x: l, y: -s / 2 },
    { x: l - i, y: -s },
...
var Ct = (r, t) => {
  const { shapeSvg: e, bbox: n } = S2(r, t, void 0, true), a = n.width + t.padding, s = n.height + t.padding, i = [
    { x: -s / 2, y: 0 },
    { x: a, y: 0 },
    { x: a, y: -s },
    { x: -s / 2, y: -s },
...
var Nt2 = (r, t) => {
  const { shapeSvg: e, bbox: n } = S2(r, t, void 0, true), a = n.width + t.padding, s = a / 2, i = s / (2.5 + a / 50), l = n.height + i + t.padding, c = "M 0," + i + " a " + s + "," + i + " 0,0,0 " + a + " 0 a " + s + "," + i + " 0,0,0 " + -a + " 0 l 0," + l + " a " + s + "," + i + " 0,0,0 " + a + " 0 l 0," + -l, o = e.attr("label-offset-y", i).insert("path", ":first-child").attr("style", t.style).attr("d", c).attr("transform", "translate(" + -a / 2 + "," + -(l / 2 + i) + ")");
...
var $t = (r, t) => {
  const { shapeSvg: e, bbox: n, halfPadding: a } = S2(r, t, "node " + t.classes, true), s = e.insert("rect", ":first-child"), i = n.width + t.padding, l = n.height + t.padding;
  if (s.attr("class", "basic label-container").attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("x", -n.width / 2 - a).attr("y", -n.height / 2 - a).attr("width", i).attr("height", l), t.props) {
    ...
    t.props.borders && (rt(s, t.props.borders, i, l), c.delete("borders")), c.forEach((o) => {
      et.warn(`Unknown node property ${o}`);
    });
  }
...
var Wt = (r, t) => {
  const { shapeSvg: e } = S2(r, t, "label", true);
  et.trace("Classes = ", t.classes);
  ...
  if (n.attr("width", a).attr("height", s), e.attr("class", "label edgeLabel"), t.props) {
    ...
    t.props.borders && (rt(n, t.props.borders, a, s), i.delete("borders")), i.forEach((l) => {
      et.warn(`Unknown node property ${l}`);
    });
  }
...
function rt(r, t, e, n) {
  ...
  t.includes("t") ? (et.debug("add top border"), s(e)) : i(e), t.includes("r") ? (et.debug("add right border"), s(n)) : i(n), t.includes("b") ? (et.debug("add bottom border"), s(e)) : i(e), t.includes("l") ? (et.debug("add left border"), s(n)) : i(n), r.attr("stroke-dasharray", a.join(" "));
}
var Xt = (r, t) => {
  let e;
  ...
  let c = "";
  typeof l == "object" ? c = l[0] : c = l, et.info("Label text abc79", c, l, typeof l == "object");
  const o = i.node().appendChild(T2(c, t.labelStyle, true, true));
  let h = { width: 0, height: 0 };
  if (Ol(po().flowchart.htmlLabels)) {
    const x = o.children[0], y = yh(o);
  ...
  const d = i.node().appendChild(
    T2(f.join ? f.join("<br/>") : f, t.labelStyle, true, true)
  );
  if (Ol(po().flowchart.htmlLabels)) {
    const x = d.children[0], y = yh(d);
    h = x.getBoundingClientRect(), y.attr("width", h.width), y.attr("height", h.height);
  }
  const p = t.padding / 2;
  return yh(d).attr(
...
var Yt = (r, t) => {
  const { shapeSvg: e, bbox: n } = S2(r, t, void 0, true), a = n.height + t.padding, s = n.width + a / 4 + t.padding, i = e.insert("rect", ":first-child").attr("style", t.style).attr("rx", a / 2).attr("ry", a / 2).attr("x", -s / 2).attr("y", -a / 2).attr("width", s).attr("height", a);
  return m(t, i), t.intersect = function(l) {
    return g.rect(t, l);
  }, e;
};
var Ut = (r, t) => {
  const { shapeSvg: e, bbox: n, halfPadding: a } = S2(r, t, void 0, true), s = e.insert("circle", ":first-child");
  return s.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + a).attr("width", n.width + t.padding).attr("height", n.height + t.padding), et.info("Circle main"), m(t, s), t.intersect = function(i) {
    return et.info("Circle intersect", t, n.width / 2 + a, i), g.circle(t, n.width / 2 + a, i);
  }, e;
};
var At = (r, t) => {
  const { shapeSvg: e, bbox: n, halfPadding: a } = S2(r, t, void 0, true), s = 5, i = e.insert("g", ":first-child"), l = i.insert("circle"), c = i.insert("circle");
  return l.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + a + s).attr("width", n.width + t.padding + s * 2).attr("height", n.height + t.padding + s * 2), c.attr("style", t.style).attr("rx", t.rx).attr("ry", t.ry).attr("r", n.width / 2 + a).attr("width", n.width + t.padding).attr("height", n.height + t.padding), et.info("DoubleCircle main"), m(t, l), t.intersect = function(o) {
    return et.info("DoubleCircle intersect", t, n.width / 2 + a + s, o), g.circle(t, n.width / 2 + a + s, o);
  }, e;
};
var Ot = (r, t) => {
  const { shapeSvg: e, bbox: n } = S2(r, t, void 0, true), a = n.width + t.padding, s = n.height + t.padding, i = [
...
var Zt = (r, t) => {
  ...
  let d = 0;
  const p = t.classData.annotations && t.classData.annotations[0], x = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", y = b.node().appendChild(T2(x, t.labelStyle, true, true));
  let k = y.getBBox();
  if (Ol(po().flowchart.htmlLabels)) {
    const E = y.children[0], M = yh(y);
  ...
  t.classData.type !== void 0 && t.classData.type !== "" && (po().flowchart.htmlLabels ? H += "&lt;" + t.classData.type + "&gt;" : H += "<" + t.classData.type + ">");
  const N = b.node().appendChild(T2(H, t.labelStyle, true, true));
  yh(N).attr("class", "classTitle");
  let B = N.getBBox();
  if (Ol(po().flowchart.htmlLabels)) {
    const E = N.children[0], M = yh(N);
  ...
  t.classData.members.forEach((E) => {
    const M = T(E);
    let $ = M.displayText;
    po().flowchart.htmlLabels && ($ = $.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
...
var tr = (r, t, e) => {
  ...
  if (t.link) {
    let s;
    po().securityLevel === "sandbox" ? s = "_top" : t.linkTarget && (s = t.linkTarget || "_blank"), n = r.insert("svg:a").attr("xlink:href", t.link).attr("target", s), a = G[t.shape](n, t, e);
  } else
...
var ir = (r, t) => {
  const e = Ol(po().flowchart.htmlLabels), n = t.labelType === "markdown" ? Nt(r, t.label, {
    style: t.labelStyle,
    useHtmlLabels: e,
    addSvgBackground: true
  }) : T2(t.label, t.labelStyle);
  et.info("abc82", t, t.labelType);
  const a = r.insert("g").attr("class", "edgeLabel"), s = a.insert("g").attr("class", "label");
  s.node().appendChild(n);
  let i = n.getBBox();
  if (e) {
    const c = n.children[0], o = yh(n);
  ...
  let l;
  if (t.startLabelLeft) {
    const c = T2(t.startLabelLeft, t.labelStyle), o = r.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
  ...
  if (t.startLabelRight) {
    const c = T2(t.startLabelRight, t.labelStyle), o = r.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
  ...
  if (t.endLabelLeft) {
    const c = T2(t.endLabelLeft, t.labelStyle), o = r.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
    l = h.node().appendChild(c);
    const f = c.getBBox();
    h.attr("transform", "translate(" + -f.width / 2 + ", " + -f.height / 2 + ")"), o.node().appendChild(c), L[t.id] || (L[t.id] = {}), L[t.id].endLeft = o, A(l, t.endLabelLeft);
  }
  if (t.endLabelRight) {
    const c = T2(t.endLabelRight, t.labelStyle), o = r.insert("g").attr("class", "edgeTerminals"), h = o.insert("g").attr("class", "inner");
    l = h.node().appendChild(c);
    const f = c.getBBox();
...
function A(r, t) {
  po().flowchart.htmlLabels && r && (r.style.width = t.length * 9 + "px", r.style.height = "12px");
}
var nr = (r, t) => {
  et.info("Moving label abc78 ", r.id, r.label, O[r.id]);
  let e = t.updatedPath ? t.updatedPath : t.originalPath;
  if (r.label) {
    const n = O[r.id];
    let a = r.x, s = r.y;
    if (e) {
      const i = _s.calcLabelPosition(e);
      et.info(
  ...
  if (r.startLabelLeft) {
    ...
    let a = r.x, s = r.y;
    if (e) {
      const i = _s.calcTerminalLabelPosition(r.arrowTypeStart ? 10 : 0, "start_left", e);
      a = i.x, s = i.y;
    }
    n.attr("transform", "translate(" + a + ", " + s + ")");
  }
  if (r.startLabelRight) {
    ...
    let a = r.x, s = r.y;
    if (e) {
      const i = _s.calcTerminalLabelPosition(
  ...
  if (r.endLabelLeft) {
    ...
    let a = r.x, s = r.y;
    if (e) {
      const i = _s.calcTerminalLabelPosition(r.arrowTypeEnd ? 10 : 0, "end_left", e);
      a = i.x, s = i.y;
    }
    n.attr("transform", "translate(" + a + ", " + s + ")");
  }
  if (r.endLabelRight) {
    ...
    let a = r.x, s = r.y;
    if (e) {
      const i = _s.calcTerminalLabelPosition(r.arrowTypeEnd ? 10 : 0, "end_right", e);
      a = i.x, s = i.y;
    }
    n.attr("transform", "translate(" + a + ", " + s + ")");
  }
...
var Qt = (r, t, e) => {
  et.warn(`intersection calc abc89:
  ...
  if (Math.abs(a - t.y) * i > Math.abs(n - t.x) * c) {
    ...
    return l === 0 && (b.x = t.x, b.y = t.y), h === 0 && (b.x = t.x), o === 0 && (b.y = t.y), et.warn(`abc89 topp/bott calc, Q ${o}, q ${f}, R ${h}, r ${l}`, b), b;
  } else {
    e.x < t.x ? l = t.x - i - n : l = n - i - t.x;
    let f = o * l / h, b = e.x < t.x ? e.x + h - l : e.x - h + l, d = e.y < t.y ? e.y + f : e.y - f;
    return et.warn(`sides calc abc89, Q ${o}, q ${f}, R ${h}, r ${l}`, { _x: b, _y: d }), l === 0 && (b = t.x, d = t.y), h === 0 && (b = t.x), o === 0 && (d = t.y), { x: b, y: d };
  }
};
var K = (r, t) => {
  et.warn("abc88 cutPathAtIntersect", r, t);
  let e = [], n = r[0], a = false;
  return r.forEach((s) => {
    if (et.info("abc88 checking point", s, t), !zt(t, s) && !a) {
      const i = Qt(t, n, s);
      et.warn("abc88 inside", s, n, i), et.warn("abc88 intersection", i);
      let l = false;
      e.forEach((c) => {
        l = l || c.x === i.x && c.y === i.y;
      }), e.some((c) => c.x === i.x && c.y === i.y) ? et.warn("abc88 no intersect", i, e) : e.push(i), a = true;
    } else
      et.warn("abc88 outside", s, n), n = s, a || e.push(s);
  }), et.warn("abc88 returning points", e), e;
};
var lr = function(r, t, e, n, a, s) {
  let i = e.points, l = false;
  const c = s.node(t.v);
  var o = s.node(t.w);
  et.info("abc88 InsertEdge: ", e), o.intersect && c.intersect && (i = i.slice(1, e.points.length - 1), i.unshift(c.intersect(i[0])), et.info(
    "Last point",
    i[i.length - 1],
    o,
    o.intersect(i[i.length - 1])
  ), i.push(o.intersect(i[i.length - 1]))), e.toCluster && (et.info("to cluster abc88", n[e.toCluster]), i = K(e.points, n[e.toCluster].node), l = true), e.fromCluster && (et.info("from cluster abc88", n[e.fromCluster]), i = K(i.reverse(), n[e.fromCluster].node).reverse(), l = true);
  const h = i.filter((k) => !Number.isNaN(k.y));
  let f;
  a === "graph" || a === "flowchart" ? f = e.curve || We : f = We;
  const b = S().x(function(k) {
    return k.x;
  }).y(function(k) {
    return k.y;
  }).curve(f);
  ...
  let x = "";
  switch ((po().flowchart.arrowMarkerAbsolute || po().state.arrowMarkerAbsolute) && (x = window.location.protocol + "//" + window.location.host + window.location.pathname + window.location.search, x = x.replace(/\(/g, "\\("), x = x.replace(/\)/g, "\\)")), et.info("arrowTypeStart", e.arrowTypeStart), et.info("arrowTypeEnd", e.arrowTypeEnd), e.arrowTypeStart) {
    case "arrow_cross":
...
//# sourceMappingURL=chunk-HGLEOHWR.js.map
