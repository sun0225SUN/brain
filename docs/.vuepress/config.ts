...
const DOMAIN_NAME = 'brain.sunguoqi.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "小孙同学Coding",
      description: '小孙同学的学习笔记',
    }
  },
  // base: '/', // 默认'/'。
  // 如果你想将你的网站部署到如 https://foo.github.io/bar/
  // 那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '关于', link: 'https://blog.sunguoqi.com/abouts' },
    ],
    ...
    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://blog.sunguoqi.com/upload/avatar.png',
      name: '小孙同学Coding',
      slogan: '热爱可低漫长岁月',
    },
    ...
    footer: {
      ...
      copyrightInfo:
        '小孙同学 | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  plugins: <UserPlugins>[
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        choosen: 'gitalk',
        options: {
          clientID: '449bcfc52c2232e0f2f1',
          clientSecret: 'dd27991df2bdb6b7f595b1bbe29edcf1f3cfbb9b',
          repo: 'Brain', // GitHub 仓库
          owner: 'sun0225SUN', // GitHub仓库所有者
          admin: ['sun0225SUN'], // 对仓库有写权限的人
